...
import 'package:biil_podu_app/screens/invoices_screen/new_invoice_screen/payment_instructions/payment_instructions.dart';
import 'package:biil_podu_app/screens/invoices_screen/new_invoice_screen/widgets/option_view_eng.dart';
...
class NewInvoiceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar_eng(
        title: AppStrings.NEW_INVOICE_PAYER_SUBTITLE,
        actions: [
          IconButton(
            onPressed: () {
              Get.back();
